...
<html>
  <head>
    ...
    <title>用户列表</title> 
	<script src='<%=basePath%>script/policestation/casereceiveList.js' 	type='text/javascript'></script>
  </head>
  ...
  <body>
        ...
        <div>
            <p> 
                <a id="receiveCase" name="receiveCase" doc="caseReceive"
                    href="javascript:void(0);" class="easyui-linkbutton" style="background-color:red;color:red"
                   >案件接收</a> <!-- iconcls="icon-udq-add" plain="true" -->
                <a id="rebackCase" name="rebackCase" doc="caseReBack"
                    href="javascript:void(0);" class="easyui-linkbutton" iconcls="icon-udq-add"
                    plain="true">案件反馈</a>
                <a id="showCaseInfo" name="showCaseInfo"  doc="caseReBack"
    ...
    <div style="display:none">
    	<div id="div_backInfo" style="width:520px;height:420px">
       	 ...
       	 <p>
       		<label style="font-size:12px">反馈内容：</label><textarea id="txtBackWords" style="width:79%" rows="3"></textarea>
       	 </p>
       	  <p>
